...
class evaluation:
    ...
    def read_settings(self):
        ...
        with open('../evaluation/output/watchpoint.json','r') as f:
            a_dict = json.loads(f.read())
    ...
    def generate_stage1_control_file(self):
        with open("../workspace/{}.sp".format(self.logname),'w') as f:
    ...
    def parse_from_mt(self):
        ...
        with open("../workspace/{}.mt0.csv".format(self.logname),'r') as f:
